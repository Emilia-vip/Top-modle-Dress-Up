...
export const findClothingItem = (identifier, type, skin = "light") => {
    ...
    const found = collection.find((i) => i.id === identifier || i.name.toLowerCase() === identifier.toLowerCase());
    if (found)
        return found;
    ...
    return fallbackCollection.find((i) => i.id === identifier || i.name.toLowerCase() === identifier.toLowerCase()) || null;
};
